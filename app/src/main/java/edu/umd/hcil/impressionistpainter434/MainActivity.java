        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        _impressionistView.savePainting(getApplicationContext());
                    }})
                .setNegativeButton(android.R.string.no, null).show();
    }
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        _impressionistView.setTraceBackground();
                    }})
                .setNegativeButton(android.R.string.no, null).show();
    }
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menuCircle:
                ...
                return true;
            case R.id.menuSimpleSquare:
                Toast.makeText(this, "Simple Square Brush", Toast.LENGTH_SHORT).show();
                _impressionistView.setBrushType(BrushType.SimpleSquare);
                return true;
            case R.id.menuLine:
            ...
            case R.id.menuVelocitySquare:
                ...
                _impressionistView.setBrushType(BrushType.VelocitySquare);
                return true;
        }
        return false;
    }
